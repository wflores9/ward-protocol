...
export const metadata: Metadata = {
  ...
  description: 'Everything you need to integrate Ward Protocol â€” Python SDK, TypeScript SDK, live API, and enterprise licensing.',
}
    ...
    <>
      ...
      <div style={{ background: 'var(--steel-2)', borderBottom: '1px solid rgba(168,197,232,0.08)', padding: '72px 32px' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          <span style={S.label}>WARD PROTOCOL â€” BUILD</span>
      ...
      <section style={{ ...S.section, background: 'var(--steel)' }}>
        <div style={S.container}>
          <span style={S.label}>GET STARTED â€” FREE</span>
...
# ward_signed = False â€” always.`}</pre>
              </div>
...
// result.approved â€” true / false`}</pre>
              </div>
      ...
      <section style={{ ...S.section, background: 'var(--steel-2)' }}>
        <div style={S.container}>
          <span style={S.label}>GO LIVE â€” INSTITUTIONAL</span>
