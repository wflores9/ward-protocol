...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-12 py-12">
      <h1 className="font-sans font-black text-4xl text-steel mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-8 text-sm text-sub leading-relaxed">
        <section>
          <h2 className="font-sans font-black text-xl text-steel mb-2">1. Information We Collect</h2>
          <p>
        ...
        <section>
          <h2 className="font-sans font-black text-xl text-steel mb-2">2. On-Chain Data</h2>
          <p>
        ...
        <section>
          <h2 className="font-sans font-black text-xl text-steel mb-2">3. Third-Party Services</h2>
          <p>
        ...
        <section>
          <h2 className="font-sans font-black text-xl text-steel mb-2">4. Open Source</h2>
          <p>
        ...
        <section>
          <h2 className="font-sans font-black text-xl text-steel mb-2">5. Contact</h2>
          <p>
