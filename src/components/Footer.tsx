...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#061118]">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-2 md:px-10 lg:grid-cols-[1.4fr_0.9fr_0.9fr_0.9fr] lg:px-12">
        <div>
        ...
        <div>
          <p className="font-mono text-xs font-bold uppercase tracking-[0.16em] text-[#9eb0b7]">Product</p>
        ...
        <div>
          <p className="font-mono text-xs font-bold uppercase tracking-[0.16em] text-[#9eb0b7]">Institutional</p>
          <div className="mt-5 grid gap-3 text-sm text-[#d0dde0]">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-6 py-5 text-sm text-[#9eb0b7] md:px-10 lg:px-12">
