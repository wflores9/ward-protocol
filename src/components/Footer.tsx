  ...
  return (
    <footer className="border-t border-white/10 bg-[#061118]">
      <div className="site-container grid gap-12 py-16 md:grid-cols-[1.2fr_0.9fr_0.9fr]">
        <div>
          <Link href="/" className="flex items-center gap-4 no-underline">
            ...
            <div>
              ...
              <div className="font-mono text-sm uppercase tracking-[0.12em] text-[#a7c5e5]">Protocol</div>
            </div>
          </Link>

          <p className="mt-5 max-w-sm text-base leading-7 text-[#c8dce8]">
            Deterministic default-resolution infrastructure for institutional tokenized credit.
          </p>
          <p className="mt-4 max-w-sm text-sm leading-6 text-[#a7c5e5]">
        ...
        <div>
          <p className="font-mono text-sm font-bold uppercase tracking-[0.12em] text-[#a7c5e5]">Navigation</p>
          <div className="mt-5 grid gap-3 text-sm text-[#c8dce8]">
        ...
        <div>
          <p className="font-mono text-sm font-bold uppercase tracking-[0.12em] text-[#a7c5e5]">Resources</p>
          <div className="mt-5 grid gap-3 text-sm text-[#c8dce8]">
      ...
      <div className="border-t border-white/10">
        <div className="site-container flex flex-wrap items-center justify-between gap-3 py-5 text-sm text-[#a7c5e5]">
