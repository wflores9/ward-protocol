...
const stats = [
  { val: '146/146', label: 'Tests Passing', green: true },
  { val: 'v0.2.2',  label: 'SDK Version',   green: false },
...
export default function HeroCard() {
  ...
  const copy = () => {
    navigator.clipboard.writeText('pip install ward-protocol==0.2.2')
    setCopied(true)
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-steel rounded-md p-5 font-mono text-sm">
        ...
        <div className="flex items-center justify-between gap-3">
          <code className="text-ice text-[13px]">pip install ward-protocol==0.2.2</code>
          <button
            onClick={copy}
