export type ChainId = 'xrpl' | 'xrpl_evm' | 'stellar' | 'hedera' | 'solana' | 'xdc' | 'algorand' | 'polygon';
export type ChainStatus = 'E2E verified' | 'Contract deployed' | 'Account funded' | 'Testnet-ready';
export type ChainLogoId = 'xrpl' | 'xrpl_evm' | 'stellar' | 'hedera' | 'solana' | 'xdc' | 'algorand' | 'polygon';
...
export const CHAIN_ADAPTERS: ChainAdapter[] = [
  ...
  },
  {
    ...
    proof: 'Contract deployment recorded',
  ...
  },
  {
    ...
    primitiveRef: 'HTS policy serial',
    proof: 'Wallet lane prepared',
...
export const DEMO_EVENTS = [
  ...
  'Attach selected integration rail',
